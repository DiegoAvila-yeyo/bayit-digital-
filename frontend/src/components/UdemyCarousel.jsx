...
export const UdemyCarousel = ({ PRIMARY_COLOR }) => {
  ...
  if (loading) return <div className="py-16 text-center text-gray-500 italic">Buscando las mejores enseñanzas...</div>;
        ...
        <div className="relative group/carousel">
          <div className="overflow-hidden py-10 -my-10"> 
            <div 
              ...
              style={{ transform: `translateX(-${courses.length > 0 ? (currentIndex * 100) / itemsPerPage : 0}%)` }}
            >
              {courses.length > 0 ? (
                ...
                <div className="w-full text-center py-10 text-gray-400">
                  Aún no hay cursos publicados. ¡Sé el primero en subir uno!
                </div>
              )}
            </div>
          </div>
